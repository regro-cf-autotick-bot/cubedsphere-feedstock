...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/cubedsphere-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11589&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/cubedsphere-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `cubedsphere` can be installed with:

```
conda install cubedsphere
```

It is possible to list all of the versions of `cubedsphere` available on your platform with:
